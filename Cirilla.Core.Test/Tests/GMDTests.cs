...
namespace Cirilla.Core.Test.Tests
{
    ...
    public class GMDTests
    {
        ...
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/em_names_eng.gmd"));
        }

        [TestMethod]
        public void Load__q00503_eng()
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/quest/q00503_eng.gmd"));
        }

        [TestMethod]
        public void Load__item_eng()
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/item_eng.gmd"));
        }

        [TestMethod]
        public void Load__armor_eng()
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/steam/armor_eng.gmd"));
        }
        ...
        public void Load__action_trial_eng()
        {
            ...
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/action_trial_eng.gmd"));
        ...
        public void Load__action_trial_ara()
        {
            ...
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/action_trial_ara.gmd"));
        ...
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/cm_facility_eng.gmd"));
        }

        [TestMethod]
        public void Load__cm_facility_kor()
        {
            GMD gmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/cm_facility_kor.gmd"));
        }

        [TestMethod]
        public void Rebuild__em_names_eng()
        {
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/em_names_eng.gmd");
        ...
        {
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/quest/q00503_eng.gmd");
        ...
        {
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/item_eng.gmd");
        ...
        public void Rebuild__action_trial_eng()
        {
            ...
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/action_trial_eng.gmd");
        ...
        {
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/steam/wep_series_eng.gmd");
        ...
        {
            string origPath = Utility.GetExtractedAssetPath(@"chunk0/common/text/steam/w_sword_eng.gmd");
        ...
        public void AddString__q00503_eng()
        {
            ...
            GMD oldGmd = new GMD(Utility.GetExtractedAssetPath(@"chunk0/common/text/quest/q00503_eng.gmd"));
